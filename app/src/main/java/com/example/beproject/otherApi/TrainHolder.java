...
*/
    ...
    public void setContent(Train train) {
        SourceTextView.setText(train.getSource());
        DestinationTextView.setText(train.getDestination());
        trainNameTextView.setText(MessageFormat.format("{0}  ({1})", train.getTrainName(), train.getTrainNo()));
        TimeofTrain.setText(MessageFormat.format("{0} --> {1}", train.getDepartureTime(), train.getArrivalTime()));
